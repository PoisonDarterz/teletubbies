        ...
        <div className="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div className="bg-white p-10 rounded-lg relative w-3/4 h-3/4 m-auto flex">
                ...
                <div className="w-1/2 p-10">
                    <h1 className="text-2xl font-bold">How long is your meeting?</h1>
                    <div className="flex items-center mt-5 border-t border-gray-300 pt-5">
                    ...
                    <h1 className="text-xl font-bold mt-5">Which time works best</h1>
                    <div className="mt-5 p-5 border rounded flex items-center justify-center">
                        <p>9:00am</p>
                    </div>
                    <div className="mt-5 p-5 border rounded flex items-center justify-center">
                        <p>10:00am</p>
                    ...
                    <div className="mt-5 p-5 border rounded bg-[#AFE7FF] flex items-center justify-center font-bold">
                        <p>Confirm</p>
                    </div>
                </div>
            </div>
