  ...
  return (
    <div className="bg-F6F1F1">
      ...
      <div className="flex justify-between p-8" style={{ backgroundColor: '#FFFFFF' }}>
        ...
        <div className="rounded-lg p-4 relative border w-[400px] h-[540px] ml-12 mr-5" style={{ backgroundColor: '#F0EBFF', borderColor: '#D977FC' }}>          <h2 style={{ fontWeight: 'bold', textDecoration: 'underline', fontSize: '1.5em', textAlign: 'center' }}>Submitted Documents</h2>
          ...
          <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded absolute bottom-2 right-20" onClick={onAddDocumentClick}>
            Add Document
          </button>
        </div>
