...
function GeneralInfo() {
  const boxes = [
    { title: 'Team and Company Introduction', imageSrc: '/TeamIntro.jpg' },
    { title: 'Programming Language Familiarization', imageSrc: '/Programminglanguagefa.jpg' },
    { title: 'Day One Information', imageSrc: '/DayOne.jpg' },
    { title: 'Employee Handbook',  imageSrc: '/EmployeeHandbook.jpeg' },
    { title: 'Payroll and Benefits Documents', imageSrc: '/PayrollBenefit.jpg' },
  ];
