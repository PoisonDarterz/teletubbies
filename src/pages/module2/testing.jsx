...
const Testing = () => {
    const [questions] = useState([
        ...
        'How does CSS3 support responsive web design? Provide examples.',
        ...
        'What are Spring Beans? How are they defined and managed within a Spring application context?'
    ]);
    ...
    return (
        <>
          <Header />
          <div className="p-4" style={{ maxWidth: '1000px', margin: 'auto' }}>
